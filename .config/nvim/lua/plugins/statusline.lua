...
gls.left[1] = {
   FirstElement = {
      ...
      highlight = { colors.lightbg2, colors.lightbg2 },
   },
}
...
gls.left[2] = {
   statusIcon = {
      ...
      separator_highlight = { colors.lightbg2, colors.one_bg2 },
   },
}
...
gls.left[6] = {
   current_dir = {
      ...
      highlight = { colors.black, colors.lightbg2 },
      separator = right_separator,
...
local mode_colors = {
   [110] = { "NORMAL", colors.white },
   [105] = { "INSERT", colors.white },
   [99] = { "COMMAND", colors.white },
   [116] = { "TERMINAL", colors.white },
   [118] = { "VISUAL", colors.white },
   [22] = { "V-BLOCK", colors.white },
   [86] = { "V_LINE", colors.white },
   [82] = { "REPLACE", colors.white },
   [115] = { "SELECT", colors.white },
   [83] = { "S-LINE", colors.white },
}
...
gls.right[9] = {
   some_RoundIcon = {
      ...
      separator = left_separator,
      separator_highlight = { colors.white, colors.one_bg2 },
      highlight = { colors.lightbg, colors.white },
   },
}
